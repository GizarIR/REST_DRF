...
SECRET_KEY = 'django-insecure-m1r_@+pkg9*uw_r-nr)izkc50u^1#y&u2+i1-iuvplf*1!xgi1'
...
INSTALLED_APPS = [
    ...
    'myapp',
    'rest_framework',#(минимальные настройки)
]
...
# Добавлено для настройки rest_farmework
REST_FRAMEWORK = {
